...
What follows is a quick example of this using LDA as the embedding mechanism. (And for the mathematically precise, we are embedding into a probability space.)
