...
model <- FitLdaModel(dtm = dtm_sample, 
                     ...
                     burnin = 275,
                     alpha = 0.1,
                     beta = colSums(dtm_sample) / sum(dtm_sample) * 100, # asymmetric beta
                     optimize_alpha = TRUE,
...
A future version of textmineR will have an implementation of a strucural topic model from the [`stm`](https://CRAN.R-project.org/package=stm) package. 
