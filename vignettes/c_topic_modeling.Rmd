...
* LDA using Gibbs sampling from the [`lda`](https://CRAN.R-project.org/package=lda) package
* LDA using Bayesian expectation maximization from the [`topicmodels`](https://CRAN.R-project.org/package=topicmodels) package
