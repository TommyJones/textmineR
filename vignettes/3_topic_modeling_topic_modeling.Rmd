...
knitr::kable(head(t(lsa_model$top_terms)), 
             col.names = rep("", row(lsa_model$top_terms)))
```
...
* LDA using Gibbs sampling from the [`lda`](https://cran.r-project.org/web/packages/lda/index.html) package
* LDA using Bayesian expectation maximization from the [`topicmodels`](https://cran.r-project.org/web/packages/topicmodels/index.html) package
* LSA using a single value decomposition from the [`RSpectra`](https://cran.r-project.org/web/packages/RSpectra/index.html) package
* Correlated topic models (CTM) from the [`topicmodels`](https://cran.r-project.org/web/packages/topicmodels/index.html) package

A future version of textmineR will have an implementation of a strucural topic model from the [`stm`](https://cran.r-project.org/web/packages/stm/index.html) package. 
